...
By default, the GitHub App token is scoped only to the repository where the event originated. To extend access to additional repositories, see [Repository CRD Token Scoping](/guides/repository-crd#scoping-github-token-to-a-list-of-private-and-public-repositories).
...
See the [Resolver documentation](/guides/pipeline-resolution#remote-http-url-from-a-private-github-repository) for more details.
...
<Accordion title="Cannot Access Additional Private Repositories">
  ...
  **Solutions:**
  ...
  See [Token Scoping](/guides/repository-crd#scoping-github-token-to-a-list-of-private-and-public-repositories) for details.
</Accordion>
...
- [Repository CRD](/guides/repository-crd) - Repository configuration reference
- [Resolver](/guides/pipeline-resolution) - Fetching remote tasks and pipelines
- [Authoring PipelineRuns](/guides/creating-pipelines) - Template variables reference
- [GitHub App Installation](/providers/github-app) - Setting up GitHub App authentication
