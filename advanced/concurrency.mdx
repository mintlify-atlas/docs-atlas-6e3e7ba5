...
See [Running PipelineRuns](/guides/running-pipelines#canceling-a-pipelinerun) for more details.
...
See [Cleanup](/advanced/cleanup) for retention policies.
...
- [Cleanup](/advanced/cleanup) - Automatic cleanup and retention policies  
- [Running PipelineRuns](/guides/running-pipelines) - How PipelineRuns are triggered and managed
