...
See [Statuses](/guides/running-pipelines) for more notification options.
...
- [Custom Parameters](/advanced/custom-parameters) - Using dynamic parameters
- [Authoring PipelineRuns](/guides/creating-pipelines) - PipelineRun configuration
- [Repository CRD](/guides/repository-crd) - Complete Repository CR reference
- [Statuses](/guides/running-pipelines) - Status reporting and notifications
