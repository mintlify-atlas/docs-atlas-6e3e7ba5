...
- [GitOps Commands](/guides/gitops-commands) - Using /ok-to-test and other commands
- [Repository CRD](/guides/repository-crd) - Complete Repository configuration
- [Running PipelineRuns](/guides/running-pipelines) - How PipelineRuns are triggered
