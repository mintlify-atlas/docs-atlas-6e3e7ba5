...
<Accordion title="PAC Variables (pac.*)">
  ...
  See the [Authoring PipelineRuns](/docs/guide/authoringprs#default-parameters) documentation for the complete list.
</Accordion>
...
You can define parameters without a default value to require them to be passed via [GitOps commands](/docs/guide/gitops_commands):
...
- [Authoring PipelineRuns](/docs/guide/authoringprs) - Default parameters and template variables
- [GitOps Commands](/docs/guide/gitops_commands) - Passing parameters via comments
- [Advanced Event Matching](/docs/guide/matchingevents) - Using CEL expressions
