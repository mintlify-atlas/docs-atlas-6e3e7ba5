...
See [Template Variables](/docs/guide/authoringprs#variable-interpolation) for complete list.
...
- [Authoring PipelineRuns](/docs/guide/authoringprs)
- [Annotations Reference](/docs/guide/authoringprs#annotations)
- [Template Variables](/docs/guide/authoringprs#variable-interpolation)
